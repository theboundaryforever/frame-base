package com.yuehai.ui.widget.roundimageview;
...
public class RoundImageView extends AppCompatImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        type = a.getInt(R.styleable.RoundedImageView_round_type, TYPE_OVAL);
        mBorderColor = a.getColor(R.styleable.RoundedImageView_round_border_color, Color.WHITE);
        mBorderWidth = a.getDimension(R.styleable.RoundedImageView_round_border_width, 0);
        mCornerRadius = a.getDimension(R.styleable.RoundedImageView_round_corner_radius, dp2px(10));
        mLeftTopCornerRadius = a.getDimension(R.styleable.RoundedImageView_round_leftTop_corner_radius, 0);
        mLeftBottomCornerRadius = a.getDimension(R.styleable.RoundedImageView_round_leftBottom_corner_radius, 0);
        mRightTopCornerRadius = a.getDimension(R.styleable.RoundedImageView_round_rightTop_corner_radius, 0);
        mRightBottomCornerRadius = a.getDimension(R.styleable.RoundedImageView_round_rightBottom_corner_radius, 0);
