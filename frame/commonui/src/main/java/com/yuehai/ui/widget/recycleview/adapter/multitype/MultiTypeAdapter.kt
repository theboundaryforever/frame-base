...
import com.adealink.frame.commonui.recycleview.adapter.multitype.Types
...
open class MultiTypeAdapter @JvmOverloads constructor(
  ...
  inline fun <reified T : Any> register(
    ...
    // See https://github.com.adealink.frame.commonui.recycleview.adapter.multitype/issues/302
    register(T::class.java, delegate)
  }
  ...
  /**
   * 判断某个类型是否已经注册过 Binder
   */
  fun <T> isRegistered(clazz: Class<T>): Boolean {
    return types.firstIndexOf(clazz) != -1
  }
  ...
  inline fun <reified T : Any> isRegistered(): Boolean {
    return isRegistered(T::class.java)
  }
