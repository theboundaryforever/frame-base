...
import com.yuehai.ui.databinding.RoomDialogOperateTips2Binding
...
class OperateTipsRoomDialog : BaseDialogFragment(R.layout.room_dialog_operate_tips_2) {
    private val binding by viewBinding(RoomDialogOperateTips2Binding::bind)
    ...
    class Builder {
        private val dialog = OperateTipsRoomDialog()
        ...
        fun build(): OperateTipsRoomDialog = dialog
    }
